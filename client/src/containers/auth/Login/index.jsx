      ...
      <Fragment>
        ...
        <div className={`columns is-centered is-vcentered is-mobile`}>
          <div className={`column is-5-widescreen is-7-desktop is-7-tablet`}>
            <form action="" className={`auth-form login-form`} id="auth-login-form" name="loginForm" onSubmit={this.handleLoginSubmit}>
              ...
              <div className={`field`} data-class="login-password">
                ...
                {this.state.passwordValidation.text && <p
                  className={'help ' + (this.state.passwordValidation.valid ? ' is-success' : 'is-danger' )}>
                  {this.state.passwordValidation.text}</p> }
              </div>
