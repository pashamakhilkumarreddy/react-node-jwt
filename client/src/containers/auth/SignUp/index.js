        ...
        <div className={`container`}>
          <div className={`columns is-centered`}>
            <div className={`column is-5-widescreen is-7-desktop is-7-tablet`}>
              <form action="" className={`auth-form signup-form`} id="auth-signup-form" name="signUpForm">
                ...
                <div className={`terms-and-conditions`}>
                  <div className={`field`} data-class="signup-checkbox">
                    <label htmlFor="signup-checkbox" className={`checkbox`}>
                      <input id="signup-checkbox" type="checkbox" checked={this.state.rememberMe} onChange={this.handleRememberMe} />
